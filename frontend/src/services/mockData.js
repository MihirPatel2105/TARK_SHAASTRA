...
export const mockComplaints = [
  {
    ...
    verification: { gpsMatch: true, photoUploaded: true },
    scoring: {
  ...
  },
  {
    ...
    verification: { gpsMatch: true, photoUploaded: false },
    scoring: {
  ...
  },
  {
    ...
    verification: { gpsMatch: false, photoUploaded: false },
    scoring: {
  ...
  },
  {
    ...
    verification: { gpsMatch: false, photoUploaded: true },
    scoring: {
