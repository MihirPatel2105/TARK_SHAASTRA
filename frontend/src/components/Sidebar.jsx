...
function Sidebar({ role = "Citizen" }) {
  ...
  return (
    <aside className="w-full rounded-lg border border-slate-300 bg-white shadow-sm">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `inline-flex min-w-max items-center gap-2 rounded-lg px-4 py-2.5 text-sm font-semibold transition ${
                  isActive ? "bg-blue-800 text-white" : "border border-slate-200 text-slate-700 hover:bg-slate-100"
                }`
              }
            >
              <Icon size={16} />
